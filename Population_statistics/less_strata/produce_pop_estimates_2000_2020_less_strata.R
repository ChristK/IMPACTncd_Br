...
tt[educbr < 2141, educ := 1L]
tt[between(educbr, 2141, 3910), educ := 2L]
...
ttt <- CJ(age = 0:100, sex = 1:2, race3 = 1:2, educ = 1:2) # all combinations of age/sex/race/educ
...
fwrite(zz,"~/pCloudDrive/My Models/Brazil_salt_model/Population_statistics/less_strata/pop_estimates_2000_2020_age_sex_race_educ_less_strata.csv")
