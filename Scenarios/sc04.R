...
## User inputs -----
sc_inputs <- list()
sc_inputs$names <- "sc04" # REMEMBER TO UPDATE for new scenarios
...
sc_inputs$men_salt_other_change   <- -0.805  # Mean change in other salt for men (g/d)
sc_inputs$women_salt_other_change <- -0.805  # Mean change in other salt for women (g/d)
